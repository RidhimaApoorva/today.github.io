...
?>		
		...
		<div class="maincontentText" align="left" display="float">
		 <div class="contentLeft" >
			...
			<p align="Left"  style="font-size:33px ;color: #A62428">Welocome To Hanzala Export</p></br>
			  <div> <p  align="Left" style="font-size:15px ;Color:#A62428;">
				<?php
				$result="select * FROM `home` ORDER BY `id` DESC";
				$query=mysql_query($result);
				while($row=mysql_fetch_array($query))
				{
					...
					echo "	
					<tr>
						<td><img src='image/$image2' align-left='left' max-height='1%' width='25%' ></img></td>
				...
				city of Uttar Pradesh (India). </p></div>
				...
				clients at most economical prices. Fabricated using high-grade tanned leather.</br></br>
				<div><?php
				$result="select * FROM `home` ORDER BY `id` DESC";
				$query=mysql_query($result);
				while($row=mysql_fetch_array($query))
				{
					...
					echo "	
					<tr>
						<td><img src='image/$image3' align-left='left' max-height='1%' width='25%' ></img></td>
				...
				among the clients</p>
										...
										<div class="contentRight" align ="Right">
											...
											<marquee direction="up" style="margin-top:2vh;">
	...
	while($row=mysql_fetch_array($query))
	{
		...
		echo "	
		<tr>
			<td><img src='image/$image2'  height=25% width=100%></img></td>
